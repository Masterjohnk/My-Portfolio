    ...
    return Column(
      ...
      children: [
            ...
            children: [
              ...
              AnimatedTextKit(
                animatedTexts: [
                  ...
                  TyperAnimatedText('SoftwareEngineer',
                      textStyle: AppTextStyles.montserratStyle(
                          color: Colors.lightBlue))
                ],
        ...
        FadeInDown(
          ...
          child: Expanded(
            child: Text(
              'Experienced software developer with a proven track record of designing, developing, and deploying high-quality software solutions.'
